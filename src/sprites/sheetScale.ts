...
export const WEAPON_BODY: Record<string, { w: number; h: number }> = {
  ...
  wpn_rubberChicken: { w: 25, h: 32 },
  wpn_banana: { w: 29, h: 32 },
  wpn_pillow: { w: 36, h: 32 },
  wpn_toiletBrush: { w: 32, h: 32 },
  wpn_fryingPan: { w: 35, h: 32 },
  wpn_rubberDuck: { w: 34, h: 32 },
  wpn_rubberBoot: { w: 28, h: 32 },
};
